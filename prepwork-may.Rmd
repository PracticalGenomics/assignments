...
24) View beta_cell_samples by typing its name. 
...
26) View adult_cell_samples. Besides typing the name of the variable containing the data you wish to visualize, you can view the results of a command you just typed by placing the entire command in parentheses. For this answer, copy your command and add parentheses around it.
...
31) View adult_or_beta_cell_samples.
...
48) View sra_adult_beta to be sure it outputs what you expect.
